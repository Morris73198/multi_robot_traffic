...
def generate_launch_description():
    ...
    robots_known_poses = [
        ...
        {"name": "robot3", "x_pose": 2.0, "y_pose": 2.0, "z_pose": 0.01},  # 新增
        {"name": "robot4", "x_pose": 3.0, "y_pose": 1.0, "z_pose": 0.01},  # 新增
    ]
    ...
    robots_unknown_poses = [
        ...
        {"name": "robot3", "x_pose": -4.0, "y_pose": 0.5, "z_pose": 0.01},  # 新增
        {"name": "robot4", "x_pose": -5.0, "y_pose": 0.5, "z_pose": 0.01},  # 新增
    ]
    ...
    declare_robot4_params_file_cmd = DeclareLaunchArgument(
        "robot4_params_file",
        default_value=os.path.join(
            launch_dir_map_merge, "config", "nav2_multirobot_params_4.yaml"
        ),
